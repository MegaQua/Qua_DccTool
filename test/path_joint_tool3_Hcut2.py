...
class MB_jointPath_tool(QtWidgets.QWidget):
    def __init__(self):
        self.GPJoint = "tentacle_mainL1"
        #self.childRoot = ["tentacleU_A1","tentacleU_B1","tentacleU_C1","tentacleU_D1","tentacleU_E1","tentacleU_F1",]
        self.childRoot = ["tentacleL_A1","tentacleL_B1","tentacleL_C1","tentacleL_D1","tentacleL_E1","tentacleL_F1",]
...
for curve_name, obj_names in zip(curve_names, obj_names_list):
    ...
    def main(self):
        ...
        Cons_location = self.interpolate_between_first_and_last(joints_base, self.conNum)
        ...
        joints_copy_yoffset = self.create_dummys(joints_base, dummytype="Y", offset=(0, 1, 0), P=True)
        ...
        joints_copy_zoffset = self.create_dummys(joints_base, dummytype="Z", offset=(0, 0, 1),P=True)
        ...
        for jointsChain in jointsChains:
            ...
            self.jointchain_parent(jointsConsOffsets,FKCons)
